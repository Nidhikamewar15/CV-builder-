...
public class About {
	...
	private void initialize() {
		...
		txtrThisAppIs.setText("This app is Created By IIIT A students ");
		...
		txtrOopLabProject.setText("OOM lab Project: Resume Builder");
		...
		txtrUserNameIqra.setText("User Name: root");
		...
		txtrPasswordIqra.setText("Password: root");
