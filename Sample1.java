...
public class Sample1 {
	...
	private void initialize() {
		...
		JLabel lblOrganizedAndMotivated = new JLabel("To make use of my interpersonal skills ");
		...
		JLabel lblAndOrganizationalSkills = new JLabel("to achieve goals of a company that focuses on customer satisfaction and customer experience.");
		...
		JLabel lblSeekingToJoin = new JLabel("With good internal communications and budget management.");
